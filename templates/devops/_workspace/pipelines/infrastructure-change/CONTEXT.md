...
| Task | Go to |
|---|---|
| Clarify request | `stages/00_request/CONTEXT.md` |
| Discover current state | `stages/01_discovery/CONTEXT.md` |
| Plan change | `stages/02_plan/CONTEXT.md` |
| Review risk | `stages/03_review/CONTEXT.md` |
| Define validation | `stages/04_validation/CONTEXT.md` |
| Finalize packet | `stages/05_finalize/CONTEXT.md` |
