...
| Run archive | Completed approved runs | parent workspace `_workspace/runs/archive/` |
...
- After the final stage is approved, ask before moving `_workspace/runs/active/<run-slug>/` to `_workspace/runs/archive/<run-slug>/`.
